...
#ifndef KEEPASSX_AUTOTYPEWIN32_H
#define KEEPASSX_AUTOTYPEWIN32_H
...
class AutoTypePlatformWin32 : public QObject, public AutoTypePlatformInterface
{
    Q_OBJECT
    Q_INTERFACES(AutoTypePlatformInterface)

public:
    AutoTypePlatformWin32();
...
class AutoTypeExecturorWin32 : public AutoTypeExecutor
{
public:
    explicit AutoTypeExecturorWin32(AutoTypePlatformWin32* platform);

    void execChar(AutoTypeChar* action);
    void execKey(AutoTypeKey* action);

private:
    AutoTypePlatformWin32* const m_platform;
};

#endif // KEEPASSX_AUTOTYPEWin32_H
